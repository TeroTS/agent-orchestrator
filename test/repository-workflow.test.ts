...
import { loadWorkflowDefinition, validateWorkflowForDispatch } from "../src/workflow-loader.js";
...
describe("repository WORKFLOW.md", () => {
  it("ships a valid default workflow definition for the TypeScript service", async () => {
    ...
    const definition = await loadWorkflowDefinition({ workflowPath: repositoryWorkflowPath });
